...
valid_variables <- c("reported_height","reported_weight","reported_hb")
...
saveRDS(child_model_summary,paste0(path_response_folder,"/working/child non reporting with state model summary.RDS"))